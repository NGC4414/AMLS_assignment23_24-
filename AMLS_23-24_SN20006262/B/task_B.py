...
from B.train_and_test_B import (create_vgg, evaluate_and_visualize_model, 
                                ...
                                show_sample_images, plot_training_history, train_model_vgg_cross, train_model_vgg_focal, train_model_vgg_with_augmentation_cross, train_model_vgg_with_augmentation_focal)
...
#                 history = train_model_focal_loss(model, x_train, y_train, x_val, y_val, learning_rate=0.001, epochs=50, batch_size=256, patience=5, model_path='B/vgg_no_aug.h5')
#             else:
...
#                 history = train_model_vgg_with_augmentation(model, x_train, y_train, x_val, y_val, learning_rate=0.001, epochs=50, batch_size=256, patience=5, model_path='B/vgg_with_aug.h5')
